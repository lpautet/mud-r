...
pub const MAX_NAME_LENGTH: i32 = 20; /* Used in char_file_u *DO*NOT*CHANGE* */
pub const MAX_PWD_LENGTH: i32 = 10; /* Used in char_file_u *DO*NOT*CHANGE* */
...
pub struct CharData<'a> {
    ...
    //
    pub player: CharPlayerData<'a>, /* Normal data                   */
...
pub struct CharPlayerData<'a> {
    // char	passwd[MAX_PWD_LENGTH+1]; /* character's password      */
    pub name: &'a str, /* PC / NPC s name (kill ...  )         */
    pub short_descr: &'a str, /* for NPC 'actions'                    */
